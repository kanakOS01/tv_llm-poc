...
def main(**kwargs):
    ...
    sines = [Sine() for p in range(tv.pn)]
    ...
    tv.iml.mp_pose2sines = {
        "type": "fun2fun",
        "size": (tv.s.pose.size, tv.s.oscs_p.size),
        "io": (tv.s.pose.to_vec, tv.s.oscs_p.from_vec),
        "randomise": True,
        # 'rand_method': 'uniform',
    ...
    def flock_av(particles: ti.template()):
        ...
        for i in range(n):
            ...
            tv.px.line(
                p1.pos.x,
                p1.pos.y,
                p1.pos.x + fp.align.x * 100.0,
                p1.pos.y + fp.align.y * 100.0,
                c,
            )
            tv.px.line(
                p1.pos.x, p1.pos.y, p1.pos.x + fp.cohere.x, p1.pos.y + fp.cohere.y, b
            )
            tv.px.circle(p1.pos.x, p1.pos.y, fp.nearby, c)
            # tv.px.line(
            #     p1.pos.x, p1.pos.y,
            #     p1.pos.x + p1.vel.x,
            #     p1.pos.y + p1.vel.y,
